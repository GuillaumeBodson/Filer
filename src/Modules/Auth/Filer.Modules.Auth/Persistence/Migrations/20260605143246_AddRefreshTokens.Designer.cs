...
namespace Filer.Modules.Auth.Persistence.Migrations
{
    ...
    [Migration("20260605143246_AddRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Filer.Modules.Auth.Domain.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Filer.Modules.Auth.Domain.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Filer.Modules.Auth.Domain.RefreshToken", b =>
                {
                    b.HasOne("Filer.Modules.Auth.Domain.ApplicationUser", null)
                        .WithMany()
